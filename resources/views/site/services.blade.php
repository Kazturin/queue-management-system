...
@section('content')
    <div class="container mx-auto">
        <div class="flex items-center justify-center my-8">
            <img class="w-12 h-12 mr-4" src="{{ asset('img/logo.png') }}" alt="logo">
            <div class="">
                <div class="text-gray-700 text-3xl font-semibold text-center">
                    Электронды кезек
                </div>
        ...
        <div class="grid grid-cols-1 gap-6 md:grid-cols-4 2xl:grid-cols-5">
            @foreach($services as $service)
                <div class="flex justify-start flex-col border-2 border-primary-600 rounded-md">
                    <div class="p-4 bg-primary-600 text-white font-semibold text-xl"> {{$service->name}} </div>
